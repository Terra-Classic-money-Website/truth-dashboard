  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle="Participation rates, voting power coverage, and turnout trends will be shown here."
      />
      <div className="grid gap-4 md:grid-cols-2">
        {["Turnout Rate", "Voting Power Coverage"].map((label) => (
          <div
            key={label}
      ...
      <div className="rounded-xl border border-dashed border-slate-800 bg-slate-900/30 p-8 text-sm text-slate-400">
        Participation trend chart will live here.
      </div>
    </div>
  );
}
